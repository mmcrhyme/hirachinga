...
def main():
    ...
    new_text_set35 = TextSet(scene_id=1)
    new_text_set36 = TextSet(scene_id=1)
    new_text_set37 = TextSet(scene_id=1)
    new_text_set38 = TextSet(scene_id=1)
    new_text_set39 = TextSet(scene_id=1)
    new_text_set40 = TextSet(scene_id=1)
    new_text_set41 = TextSet(scene_id=1)
    new_text_set42 = TextSet(scene_id=1)
    new_text_set43 = TextSet(scene_id=1)
    new_text_set44 = TextSet(scene_id=1)
    new_text_set45 = TextSet(scene_id=1)
    new_text_set46 = TextSet(scene_id=1)
    ...
    session.add(new_text_set35)
    session.add(new_text_set36)
    session.add(new_text_set37)
    session.add(new_text_set38)
    session.add(new_text_set39)
    session.add(new_text_set40)
    session.add(new_text_set41)
    session.add(new_text_set42)
    session.add(new_text_set43)
    session.add(new_text_set44)
    session.add(new_text_set45)
    session.add(new_text_set46)
   ...
   text="(目で訴える)ひらちん(じーっ。。。じーっ。。。じー's。。。)",
    ...
    new_text244 = Text(
    text="(ケンカをとめるために間に入る) Takuya:「まぁまぁ、一旦落ち着いて。」",
    background_image="244.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text245 = Text(
    text="女性C:「どう落ち着けっていうのよ!Takuyaは私とこいつ、どっちが大事なの!?」",
    background_image="245.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text247 = Text(
    text="(しばらくそっとしておく) Takuya:「..........。」",
    background_image="247.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text248 = Text(
    text="女性B:「うちらのせいでTakuyaが困ってるじゃん。お互い大切な人を困らせるのはやめない?Takuya、ごめんね?」",
    background_image="248.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text250 = Text(
    text="Takuya:「正直、女性Bだよ。いつも俺の状況も気持ちも理解してくれるし、大切にしてくれてるのを感じる。」",
    background_image="250.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text251 = Text(
    text="女性C:「ありえない!私がTakuyaのこと大切にしてないっていうの!?もう絶対指名しない!もう私帰る!Takuyaなんて知らない!!!」",
    background_image="251.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text252 = Text(
    text="超太客を手放してしまい、お金が300万減った。/ 女の子の満足度が10下がった。/ メンタルが30下がった。/ 女性Bを慰めるため、1時間だけアフターが確定した。",
    background_image="252.png",
    gender="male",
    progress= 0,
    mental= -30,
    money= -300,
    ...
    new_text253 = Text(
    text="女性B:「今日は私がTakuyaのこと大切にしてるってこと、ちゃんと伝わってるのがすごく嬉しかった。ありがとう。でも反対にTakuyaにとって迷惑になってるんじゃないかって不安にもなったの。」",
    background_image="253.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text255 = Text(
    text="Takuya:「もちろん、女性Cだよ。ずっと前から約束してたのにごめん。」",
    background_image="255.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text256 = Text(
    text="女性C:「ふん!ほら見なさいよ!私優しいから営業時間終了まではあんたにTakuyaのこと貸してあげるわ。その代わり、アフターは朝6時まで私とお願いね。私営業時間終わりまで外で暇つぶしに遊戯王でもやってくる。」",
    background_image="256.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text257 = Text(
    text="お金が300万増えた。/ 女の子の満足度が20上がった。/ メンタルが20下がった。/ 女性Cを慰めるため、アフターが朝6時まで確定した。",
    background_image="257.png",
    gender="male",
    progress= 0,
    mental= -20,
    money= 300,
    ...
    new_text258 = Text(
    text="女性C:「Takuya〜!今日は私の方を大切って言ってくれて嬉しかった。ありがとう。私達って本気でこの先結婚考えていいんだよ...ね......?」",
    background_image="258.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text260 = Text(
    text="Takuya:「こちらこそごめん。」",
    background_image="260.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text261 = Text(
    text="女性B&C:「ふっ...これで仲直りだね。今日は仲良く3人で朝まで飲もう〜!」",
    background_image="261.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text262 = Text(
    text="お金が500万増えた。/ 女の子の満足度が30上﻿がった。/ メンタルが10下がった。/ 朝6時までアフターが確定した。",
    background_image="262.png",
    gender="male",
    progress= 0,
    mental= -10,
    money= 500,
    ...
    new_text263 = Text(
    text="女性B:「私お寿司食べたいなぁ〜。」 女性C:「私ハンバーグ!絶対ハンバーグ!ハンバーグじゃなきゃ死ぬ!」",
    background_image="263.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text265 = Text(
    text="Takuya:「許すから今日アフターなしにして」",
    background_image="265.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text266 = Text(
    text="女性B:「私はいいよ。また今度2人きりでゆっくり話そうね。」 女性C:「なーに調子のいいこと言ってんねん頭沸いとんかボケカスゥ!アフターは私に付き合ってもらうからね。」",
    background_image="266.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text267 = Text(
    text="お金が100万増えた。/ 女の子の満足度が10下がった。/ メンタルが20下がった。/ 女性Cと朝6時までアフターが決まった。",
    background_image="267.png",
    gender="male",
    progress= 0,
    mental= -20,
    money= 100,
    ...
    new_text268 = Text(
    text="女性C:「今日は困らせちゃってごめんね。でもアフターなしって言われたのは流石の私でも傷ついちゃったな...。」",
    background_image="268.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text270 = Text(
    text="Takuya:「後少しだけ頑張れば今の仕事もやめて一緒になれるから、後少し我慢してほしい。」",
    background_image="270.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text271 = Text(
    text="女性B:「そうだよね...。私ももう少し頑張る!真剣に考えてくれてありがとう。」",
    background_image="271.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text272 = Text(
    text="お金が100万増えた。/ 女の子の満足度が30上がった。/ メンタルが10下がった。/ アフターが1時間で終わったため、帰宅後課題に取り組めた。課題進捗が10%上がった。",
    background_image="272.png",
    gender="male",
    progress= 10,
    mental= -10,
    money= 100,
    ...
    new_text274 = Text(
    text="女性B:「あはは(笑)Takuyaのそういうポジティブなとこに毎回救われるんだ。ありがとう。なんとかなるよね!」",
    background_image="274.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text276 = Text(
    text="Takuya:「うん、本気だよ。俺も今の仕事もうちょっと頑張って稼ぐから、もっと貢いでくれ。」",
    background_image="276.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text277 = Text(
    text="女性C:「嬉しい...!もちろんだよ!私もっとTakuyaに貢ぐね!!!」",
    background_image="277.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text278 = Text(
    text="アフターは朝6時まで続いた。/ お金が300万増えた。/ 女の子の満足度が30上﻿がった。/ メンタルが30下がった。",
    background_image="278.png",
    gender="male",
    progress= 0,
    mental= -30,
    money= 300,
    ...
    new_text279 = Text(
    text="Takuya:「ちょっと考えさせてほしい。」",
    background_image="279.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text280 = Text(
    text="女性C:「なにそれ...。ちょっとどういうこと!?もういい私帰る...!」",
    background_image="280.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text282 = Text(
    text="Takuya:「俺もお寿司の気分だなぁ〜」",
    background_image="282.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text283 = Text(
    text="女性B:「流石Takuya!気が合うね。」 女性C:「私もう帰る!」",
    background_image="283.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text284 = Text(
    text="お金が200万減った。/ 女の子の満足度が10上がった。/ メンタルが10下がった。/ 女性Bだけになったのでアフターが3時で終わった。課題進捗が10%上がった",
    background_image="284.png",
    gender="male",
    progress= 10,
    mental= -10,
    money= -200,
    ...
    new_text285 = Text(
    text="Takuya:「この時間にハンバーグはきつい」",
    background_image="285.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text286 = Text(
    text="女性C:「私を想ってくれてるの...?じゃあお寿司のハンバーグで我慢する!」",
    background_image="286.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text287 = Text(
    text="お金が100万増えた。/ 女の子の満足度が20上がった。/ メンタルが20下がった。/ アフターは結局朝6時まで続いた。",
    background_image="287.png",
    gender="male",
    progress= 0,
    mental= -20,
    money= 100,
    ...
    new_text288 = Text(
    text="Takuya:「そうだよね。ごめん。今日は最後まで一緒にいよう」",
    background_image="288.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text289 = Text(
    text="女性C:「え!いいの!?嬉しい〜幸せ〜Takuyaしか勝たんわ〜」",
    background_image="289.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text290 = Text(
    text="お金が200万増えた。/ 女の子の満足度が20﻿上がった。/ メンタルが20下がった。/結局アフターは朝6時まで続いた。",
    background_image="290.png",
    gender="female",
    progress= 0,
    mental= -20,
    money= 200,
    ...
    new_text291 = Text(
    text="Takuya:「実は課題に追われてて、あんなこと言っちゃった」",
    background_image="291.png",
    gender="male",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    new_text292 = Text(
    text="女性C:「え、課題..?あ、プログラミングの...?勉強してるのすごいね!私20年プログラマーやってるから教えてあげるよ。初の共同作業だね...。」",
    background_image="292.png",
    gender="female",
    progress= 0,
    mental= 0,
    money= 0,
    ...
    session.add(new_text244)
    session.add(new_text245)
    session.add(new_text246)
    session.add(new_text247)
    session.add(new_text248)
    session.add(new_text249)
    session.add(new_text250)
    session.add(new_text251)
    session.add(new_text252)
    session.add(new_text253)
    session.add(new_text254)
    session.add(new_text255)
    session.add(new_text256)
    session.add(new_text257)
    session.add(new_text258)
    session.add(new_text259)
    session.add(new_text260)
    session.add(new_text261)
    session.add(new_text262)
    session.add(new_text263)
    session.add(new_text264)
    session.add(new_text265)
    session.add(new_text266)
    session.add(new_text267)
    session.add(new_text268)
    session.add(new_text269)
    session.add(new_text270)
    session.add(new_text271)
    session.add(new_text272)
    session.add(new_text273)
    session.add(new_text274)
    session.add(new_text275)
    session.add(new_text276)
    session.add(new_text277)
    session.add(new_text278)
    session.add(new_text279)
    session.add(new_text280)
    session.add(new_text281)
    session.add(new_text282)
    session.add(new_text283)
    session.add(new_text284)
    session.add(new_text285)
    session.add(new_text286)
    session.add(new_text287)
    session.add(new_text288)
    session.add(new_text289)
    session.add(new_text290)
    session.add(new_text291)
    session.add(new_text292)
    session.add(new_text293)
    ...
    new_choice80 = Choice(choice_text="正直、女性Bだよ", scene_id=1, belong_text_set_id=33)
    new_choice81 = Choice(choice_text="もちろん、女性Cだよ", scene_id=1, belong_text_set_id=33)
    new_choice82 = Choice(choice_text="こちらこそごめん。", scene_id=1, belong_text_set_id=34)
    new_choice83= Choice(choice_text="許すから今日アフターなしにして", scene_id=1, belong_text_set_id=34)
    new_choice84 = Choice(choice_text="あと少しだけ頑張れば今の仕事もやめて一緒になれるから、後少し我慢してほしい", scene_id=1, belong_text_set_id=35)
    new_choice85 = Choice(choice_text="なんとかなるさ〜", scene_id=1, belong_text_set_id=35)
    new_choice86 = Choice(choice_text="うん、本気だよ", scene_id=1, belong_text_set_id=36)
    new_choice87= Choice(choice_text="ちょっと考えさせてほしい", scene_id=1, belong_text_set_id=36)
    new_choice88 = Choice(choice_text="俺もお寿司の気分", scene_id=1, belong_text_set_id=37)
    new_choice89= Choice(choice_text="この時間にハンバーグはきつい", scene_id=1, belong_text_set_id=37)
    new_choice90 = Choice(choice_text="そうだよね。ごめん。今日は最後まで一緒にいよう", scene_id=1, belong_text_set_id=38)
    new_choice91= Choice(choice_text="実は課題に追われてて、あんなこと言っちゃった", scene_id=1, belong_text_set_id=38)
    new_choice92 = Choice(choice_text="木曜日へ進む", scene_id=1, belong_text_set_id=39)
    new_choice93 = Choice(choice_text="木曜日へ進む", scene_id=1, belong_text_set_id=40)
    new_choice94 = Choice(choice_text="木曜日へ進む", scene_id=1, belong_text_set_id=41)
    new_choice95= Choice(choice_text="木曜日へ進む", scene_id=1, belong_text_set_id=42)
    new_choice96 = Choice(choice_text="木曜日へ進む", scene_id=1, belong_text_set_id=43)
    new_choice97= Choice(choice_text="木曜日へ進む", scene_id=1, belong_text_set_id=44)
    new_choice98 = Choice(choice_text="木曜日へ進む", scene_id=1, belong_text_set_id=45)
    new_choice99= Choice(choice_text="木曜日へ進む", scene_id=1, belong_text_set_id=46)
    ...
    session.add(new_choice80)
    session.add(new_choice81)
    session.add(new_choice82)
    session.add(new_choice83)
    session.add(new_choice84)
    session.add(new_choice85)
    session.add(new_choice86)
    session.add(new_choice87)
    session.add(new_choice88)
    session.add(new_choice89)
    session.add(new_choice90)
    session.add(new_choice91)
    session.add(new_choice92)
    session.add(new_choice93)
    session.add(new_choice94)
    session.add(new_choice95)
    session.add(new_choice96)
    session.add(new_choice97)
    session.add(new_choice98)
    session.add(new_choice99)
    ...
    new_choice_text_set138 = ChoiceTextSet(choice_id=new_choice86.id, text_set_id=new_text_set41.id)
    new_choice_text_set139 = ChoiceTextSet(choice_id=new_choice87.id, text_set_id=new_text_set42.id)
    new_choice_text_set140 = ChoiceTextSet(choice_id=new_choice88.id, text_set_id=new_text_set43.id)
    new_choice_text_set141 = ChoiceTextSet(choice_id=new_choice89.id, text_set_id=new_text_set44.id)
    new_choice_text_set142 = ChoiceTextSet(choice_id=new_choice90.id, text_set_id=new_text_set45.id)
    new_choice_text_set143 = ChoiceTextSet(choice_id=new_choice91.id, text_set_id=new_text_set46.id)
    new_choice_text_set144 = ChoiceTextSet(choice_id=new_choice92.id)
    new_choice_text_set145 = ChoiceTextSet(choice_id=new_choice93.id)
    new_choice_text_set146 = ChoiceTextSet(choice_id=new_choice94.id)
    new_choice_text_set147 = ChoiceTextSet(choice_id=new_choice95.id)
    new_choice_text_set148 = ChoiceTextSet(choice_id=new_choice96.id)
    new_choice_text_set149 = ChoiceTextSet(choice_id=new_choice97.id)
    new_choice_text_set150 = ChoiceTextSet(choice_id=new_choice98.id)
    new_choice_text_set151 = ChoiceTextSet(choice_id=new_choice99.id)
    ...
    session.add(new_choice_text_set128)
    session.add(new_choice_text_set129)
    session.add(new_choice_text_set130)
    session.add(new_choice_text_set131)
    session.add(new_choice_text_set132)
    session.add(new_choice_text_set133)
    session.add(new_choice_text_set134)
    session.add(new_choice_text_set135)
    session.add(new_choice_text_set136)
    session.add(new_choice_text_set137)
    session.add(new_choice_text_set138)
    session.add(new_choice_text_set139)
    session.add(new_choice_text_set140)
    session.add(new_choice_text_set141)
    session.add(new_choice_text_set142)
    session.add(new_choice_text_set143)
    session.add(new_choice_text_set144)
    session.add(new_choice_text_set145)
    session.add(new_choice_text_set146)
    session.add(new_choice_text_set147)
    session.add(new_choice_text_set148)
    session.add(new_choice_text_set149)
    session.add(new_choice_text_set150)
    session.add(new_choice_text_set151)
